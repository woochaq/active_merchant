...
module ActiveMerchant #:nodoc:
  module Billing #:nodoc:
    ...
    class IdealBaseGateway < Gateway
      class_inheritable_accessor :test_url, :live_url, :server_pem, :default_expiration_period
      ...
      def confirm(transaction, options = {})
      ...
      def sign_message(private_key_data, password, data)
        ...
        signature   = private_key.sign( OpenSSL::Digest::SHA1.new, data.gsub(/ /, '').gsub(/\t/, '').gsub(/\n/, '') )
